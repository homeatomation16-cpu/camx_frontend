    ...
    <div style={{ perspective: 1200 }}>
      <motion.div
        onMouseMove={(e) => {
          ...
          e.currentTarget.style.transform = `rotateX(${-y / 18}deg) rotateY(${x / 18}deg)`;
        }}
        onMouseLeave={(e) => {
        ...
        <main className="relative z-10">
          ...
          <motion.section variants={fadeUp} initial="hidden" animate="show" className="max-w-7xl mx-auto px-6 py-24 text-center">
            ...
            <h1 className="text-5xl md:text-7xl font-black leading-tight tracking-tight">
              Smart Security <span className="text-secondary">Solutions</span>
            </h1>
          ...
          <motion.section variants={stagger} initial="hidden" whileInView="show" viewport={{ once: true }} className="max-w-7xl mx-auto px-6 pb-24">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
              ...
              <motion.div variants={fadeUp}>
                <TiltCard>
                  <div className="relative h-full rounded-3xl border border-border bg-card/70 backdrop-blur-2xl p-8 shadow-2xl overflow-hidden" style={{ transform: "translateZ(20px)" }}>
              ...
              <motion.div variants={fadeUp}>
                <TiltCard>
                  <div className="relative rounded-3xl border border-border bg-card/70 backdrop-blur-2xl p-8 shadow-2xl overflow-hidden" style={{ transform: "translateZ(20px)" }}>
