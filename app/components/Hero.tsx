  ...
  return (
    <section className="relative min-h-screen overflow-hidden pt-16 lg:pt-20">
      ...
      <div
        ...
        style={{
          backgroundImage:
            "linear-gradient(0deg, transparent 24%, #000 25%, #000 26%, transparent 27%), linear-gradient(90deg, transparent 24%, #000 25%, #000 26%, transparent 27%)",
          ...
          <div className="flex flex-col items-center text-center lg:items-start lg:text-left">
            ...
            <motion.div {...fadeUp(0.05)} className="mb-7">
              <span className="inline-flex items-center gap-2.5 rounded-full border border-secondary/25 bg-secondary/8 px-4 py-2 backdrop-blur-md dark:bg-secondary/10">
                ...
                <span className="text-[11px] font-black uppercase tracking-[0.25em] text-secondary">
            ...
            <motion.h1
              {...fadeUp(0.12)}
              className="max-w-3xl text-5xl font-black leading-[1.07] tracking-tight text-neutral-900 dark:text-white lg:text-7xl xl:text-8xl"
            >
              Smart CCTV
              <br />
            ...
            <motion.p
              {...fadeUp(0.2)}
              className="mt-6 max-w-xl text-base leading-7 text-neutral-600 dark:text-neutral-400 lg:text-lg lg:leading-8"
            >
            ...
            <motion.div
              {...fadeUp(0.28)}
              className="mt-10 flex w-full flex-col gap-3 sm:flex-row lg:w-auto"
            >
              <Link
                href="/products"
                className="group flex h-13 items-center justify-center gap-2.5 rounded-2xl bg-secondary px-8 text-sm font-bold text-white shadow-[0_8px_48px_rgba(37,99,235,0.3)] transition-all duration-300 hover:scale-[1.03] hover:shadow-[0_12px_56px_rgba(37,99,235,0.4)] lg:h-14 lg:px-10 lg:text-[15px]"
              >
                Browse Products
                <ChevronRight
                  size={16}
            ...
            <motion.div
              {...fadeUp(0.36)}
              className="mt-12 flex flex-wrap items-center justify-center gap-px overflow-hidden rounded-2xl border border-neutral-200/70 bg-neutral-200/70 dark:border-white/10 dark:bg-white/10 lg:justify-start"
            >
              {STATS.map(({ value, label }, i) => (
                <div
                  key={i}
                  className="flex flex-col items-center gap-0.5 bg-white/90 px-6 py-4 backdrop-blur-md dark:bg-neutral-900/80 lg:items-start"
                >
                  <span className="text-xl font-black text-secondary lg:text-2xl">
                    {value}
                  </span>
            ...
            <motion.div
              {...fadeUp(0.44)}
              className="mt-8 flex flex-wrap items-center justify-center gap-4 lg:justify-start lg:gap-6"
            >
