      ...
      <div>
        ...
        <div className="space-y-1">
          ...
          <button
            ...
            className={`group flex w-full items-center justify-between rounded-xl px-3 py-2 text-sm transition-all ${
              selectedCategory === "All"
                ? "bg-secondary/10 font-bold text-secondary"
                : "font-medium text-neutral-600 hover:bg-neutral-100 dark:text-neutral-300 dark:hover:bg-white/5"
            }`}
          >
                        ...
                        {subcategories.map((sub) => {
                          ...
                          return (
                            <button
                              ...
                              className={`flex w-full items-center justify-between rounded-lg px-2 py-1.5 text-[13px] transition-all ${
                                isSubSelected
      ...
      <AnimatePresence>
        {totalActive > 0 && (
          <motion.button
            ...
            className="flex w-full items-center justify-center gap-2 rounded-xl border-2 border-secondary py-2.5 text-sm font-bold text-secondary transition hover:bg-secondary hover:text-white"
          >
            Clear Filters
            <span className="flex h-5 w-5 items-center justify-center rounded-full bg-secondary text-[10px] font-black text-white transition group-hover:bg-white group-hover:text-secondary">
              {totalActive}
            </span>
          </motion.button>
        )}
