...
export default function CheckoutPage() {
  ...
  const [paymentMethod] = useState<"COD" | "BankTransfer">("COD");
    ...
    return (
      <main className="min-h-screen bg-background flex items-center justify-center px-6">
        <div className="max-w-md w-full bg-white dark:bg-card border border-border rounded-3xl p-10 text-center shadow-xl">
          ...
          <h1 className="text-3xl font-black text-neutral-900 dark:text-white">Order Successful</h1>

          <p className="mt-4 text-neutral-500 dark:text-gray-400">Your order has been placed successfully.</p>
